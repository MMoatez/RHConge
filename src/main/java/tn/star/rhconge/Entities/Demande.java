...
public class Demande {
    ...
    @JoinColumn(name = "matriculeDemandeur", referencedColumnName = "matricule")
    ...
    public int getNbValidateur() {
        return nbValidateur;
    }

    public void setNbValidateur(int nbValidateur) {
        this.nbValidateur = nbValidateur;
    }
    ...
    public User getMatriculeDemandeur() {
        return matriculeDemandeur;
    }

    public void setMatriculeDemandeur(User matriculeDemandeur) {
